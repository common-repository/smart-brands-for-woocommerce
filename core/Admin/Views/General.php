			...
			array(
				...
				'fields' => array(
					array(
						...
						'desc'     => sprintf(
							/* translators: 1: start link tag, 2: close link tag, 3: start link tag, 4: close link tag. */
							__( 'To create %1$sbeautiful layouts%2$s and access to advanced customizations, %3$sUpgrade to Pro!%4$s', 'smart-brands-for-woocommerce' ),
							'<a target="_blank" href="https://demo.shapedplugin.com/smart-brands-pro/brand-showcase/">',
							'</a>',
							'<a target="_blank" href="https://shapedplugin.com/plugin/smart-brands-for-woocommerce/?ref=1">',
							'</a>'
						),
						'options'  => array(
					...
					array(
						...
						'title_help' => '<div class="sp_brand-info-label">' . __( 'Carousel Mode', 'smart-brands-for-woocommerce' ) . '</div><div class="sp_brand-short-content">' . __( 'This feature allows you to select the most suitable carousel mode between Standard, Ticker (continuous scrolling)', 'smart-brands-for-woocommerce' ) . '</div><a class="sp_brand-open-docs" href="https://demo.shapedplugin.com/smart-brands-pro/brand-showcase/" target="_blank">' . __( 'Live Demo', 'smart-brands-for-woocommerce' ) . '</a>',
