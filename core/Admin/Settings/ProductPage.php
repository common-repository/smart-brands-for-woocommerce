				...
				'fields' => array(
					...
					array(
						...
						'content' => sprintf(
							...
							__(
								'To showcase the brands prominently on the %1$sproduct page%2$s and boost sales, %3$sUpgrade to Pro!%2$s',
								'smart-brands-for-woocommerce'
							),
							'<a target="_blank" href="https://demo.shapedplugin.com/smart-brands-pro/product/wireless-portable-charger/">',
							'</a>',
