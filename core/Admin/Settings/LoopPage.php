			...
			array(
				...
				'fields' => array(
					...
					array(
						'type'    => 'submessage',
						'content' => sprintf(
							/* translators: 1: start link tag, 2: close link tag 3: start link tag. */
							__( 'To showcase the brands effectively on the %1$sproduct shop page%2$s and grow sales, %3$sUpgrade to Pro!%2$s', 'smart-brands-for-woocommerce' ),
							'<a target="_blank" href="https://demo.shapedplugin.com/smart-brands-pro/">',
							'</a>',
